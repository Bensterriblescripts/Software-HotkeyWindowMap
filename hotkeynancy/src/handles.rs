use std::error::Error;
use winapi::um::winuser::{BringWindowToTop, EnumWindows, FindWindowW, GetWindowLongW, GetWindowTextLengthW, GetWindowTextW, IsWindowVisible, SetForegroundWindow, SetWindowLongW, SetWindowPos, ShowWindow, GWL_STYLE, SWP_FRAMECHANGED, SWP_SHOWWINDOW, SW_MINIMIZE, SW_SHOW, WS_OVERLAPPEDWINDOW, WS_POPUP, SW_SHOWMAXIMIZED};
...
pub unsafe extern "system" fn enum_windows_callback(hwnd: HWND, lparam: LPARAM) -> BOOL {
    unsafe {
        ...
        // If this window's title matches our search string
